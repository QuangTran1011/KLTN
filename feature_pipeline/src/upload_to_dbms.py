...
DATASET_ID = "kltn"
TABLE_ID = "traindatareview"

TRAIN_PATH = "/home/quangtran/Documents/KLTN2/train_df20"
TEST_PATH = "/home/quangtran/Documents/KLTN2/val_df20"
...
def concat_and_upload():
    ...
    df_train = load_parquet_from_folder(TRAIN_PATH)
    df_test = load_parquet_from_folder(TEST_PATH)
